...
Outreach Team`;
  ...
  const ensureAMPM = (timeStr: string): string => {
    ...
    if (upper.includes('AM') || upper.includes('PM')) {
      // If already has AM/PM, convert to lowercase and remove spaces
...
CFOAPAL: 1-301561-635000-146300-635003
...
Outreach Team`;
    ...
    const mailtoLink = `mailto:${encodeURIComponent(recipientEmail)}?cc=${encodeURIComponent('Evan Lorenz <elorenz2@illinois.edu>')}&subject=${encodeURIComponent(
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setPresFormData({ ...presFormData, instructorName: e.target.value })}
                />
              </div>
              <div className="space-y-2">
